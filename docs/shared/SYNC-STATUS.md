# SYNC-STATUS — Project Knowledge 同期状態

> Claude.ai の Project Knowledge にアップロード済みのファイルと、
> リポジトリ側の最新更新日を対比する。
> PKが古い場合、リポジトリのファイルを再アップロードする。

## 対象ファイル一覧

| ファイル | リポジトリの場所 | PK上のファイル名 | リポジトリ更新日 | PK版の更新日 | 状態 |
|---------|----------------|---------------|----------------|------------|------|
| CLAUDE.md | `CLAUDE.md` | CLAUDE.md | 2026-03-05 | 2026-03-05 | ✅ 同期済み |
| 戦闘仕様書 | `docs/shared/combat-spec.md` | combat-spec.md | 2026-02-25 | 2026-03-05 | ✅ 同期済み |
| コードリファレンス | `docs/shared/code-reference.md` | code-reference.md | 2026-02-26 | 2026-03-05 | ✅ 同期済み |
| Unity設定チェックリスト | `docs/shared/unity-setup-checklist.md` | unity-setup-checklist.md | 2026-02-25 | 2026-03-05 | ✅ 同期済み |
...
- ✅ 同期済み — PK版とリポジトリ版が一致
- ⚠️ 要更新 — リポジトリが新しい。PKへの再アップロードが必要
- 未登録 — PKにまだアップロードされていない
